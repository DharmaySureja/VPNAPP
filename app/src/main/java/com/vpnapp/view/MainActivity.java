...
import com.vpnapp.R;
import com.vpnapp.Utils;
import com.vpnapp.adapter.ServerListRVAdapter;
...
public class MainActivity extends AppCompatActivity implements NavItemClickListener {
    ...
    private ImageView premiumview;
    public static final String TAG = "VPNAPP";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main);
        initializeAll();
        premiumview = findViewById(R.id.premium);
    ...
    premiumview.setOnClickListener(new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Toast.makeText(getApplicationContext(),"Connecting To Premium Server",Toast.LENGTH_SHORT).show();
            changeServer.newServer(new Server("Premium",
                    Utils.getImgURL(R.drawable.crown),
                    "premium.ovpn",
                    "openvpn",
                    "ds123456"
            ));
