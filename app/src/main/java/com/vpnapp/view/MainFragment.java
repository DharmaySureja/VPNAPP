...
import com.vpnapp.CheckInternetConnection;
import com.vpnapp.R;
import com.vpnapp.SharedPreference;
import com.vpnapp.databinding.FragmentMainBinding;
import com.vpnapp.interfaces.ChangeServer;
...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.vpnBtn:
                // Vpn is running to disconnect current connection.
                if (vpnStart) {
                    confirmDisconnect();
                }else {
                    prepareVpn();
    ...
    BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
     ...
     //lastPacketReceive: last packet receive time
     //byteIn: incoming data
     //byteOut: outgoing data
    public void updateConnectionStatus(String duration, String lastPacketReceive, String byteIn, String byteOut) {
        binding.durationTv.setText("Duration: " + duration);
        binding.lastPacketReceiveTv.setText("Last Packet Received: " + lastPacketReceive + " second ago");
        binding.byteInTv.setText("Download speed: " + byteIn);
        binding.byteOutTv.setText("Upload speed: " + byteOut);
    }
